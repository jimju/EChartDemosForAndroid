 ...
 * 其它
 */
public class OtherExamplesActivity extends BasicEChartDemoActivity {
    @Override
    public List<String> getRecyclerTitles() {
        return stringArray2List("河流事件", "韦恩图", "矩形树图", "矩形树图下钻", "树形图", "树形图", "字符图");
    }
    ...
    public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
        switch (position) {
            case 0:
                mWebView.setJsonFromAsset("json/other/EventRiver.json");
                break;
            case 1:
                mWebView.setJsonFromAsset("json/other/Venn.json");
                break;
            case 2:
                mWebView.setJsonFromAsset("json/other/TreeMap.json");
                break;
            case 3:
                mWebView.setJsonFromAsset("json/other/TreeMap1.json");
                break;
            case 4:
                mWebView.setJsonFromAsset("json/other/Tree.json");
                break;
            case 5:
                mWebView.setJsonFromAsset("json/other/Tree1.json");
                break;
            case 6:
                mWebView.setJsonFromAsset("json/other/Chars.json");
                break;
        }
    }
